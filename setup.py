# Generated by Medikit 0.7.5 on 2020-07-06.
...
setup(
    ...
    install_requires=[
        'brotli ~= 1.0.4', 'django ~= 3.0.8', 'django-allauth ~= 0.42.0',
        'django-includes ~= 0.3.1', 'jinja2 ~= 2.10', 'mondrian ~= 0.8',
        'whitenoise ~= 5.1.0'
    ],
    extras_require={
        'celery': [
            'celery ~= 4.4.6', 'django_celery_beat ~= 2.0.0',
            'django_celery_results ~= 1.2.1'
        ],
        'channels': ['channels ~= 2.4.0'],
        'dev': [
            'cookiecutter ~= 1.6', 'coverage ~= 4.5',
            'django-extensions ~= 3.0.2', 'django_debug_toolbar ~= 2.2',
            'honcho ~= 1.0', 'medikit ~= 0.6', 'pyquery ~= 1.4',
            'pytest ~= 5.4', 'pytest-cov ~= 2.7', 'pytest-django ~= 3.3',
            'werkzeug ~= 0.14'
        ],
        'prod': ['gunicorn ~= 20.0.4']
    },
    entry_points={
