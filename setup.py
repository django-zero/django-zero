# Generated by Medikit 0.7.1 on 2019-04-20.
...
setup(
    ...
    extras_require={
        ...
        "channels": ["channels (~= 2.1.2)", "daphne (~= 2.2.0)", "django (~= 2.1, < 2.2)", "mondrian (~= 0.8)"],
        "dev": [
            "cookiecutter (~= 1.6)",
            "coverage (~= 4.4)",
            "django (~= 2.1, < 2.2)",
        ...
        "prod": ["django (~= 2.1, < 2.2)", "gunicorn (~= 19.9.0)", "mondrian (~= 0.8)"],
    },
